...
fconf = open("raspberrypi_trover_conf.txt", "r")
...
###############################
# Wi-Fi Hotspot Connection from Phone to Raspberry Pi (RPi)#
###############################
# UDP from phone
localPort_gps = 20001  # The RPi will open this port for receiving GPS from phone.
bufferSize = 1024
